...
// @desc   ADD profiles profile exprience
// @access Private
router.put(
  "/experience",
  [
...
// @desc   ADD profiles profile education
// @access Private
router.put(
  "/education",
  [
  ...
  try {
    const options = {
      uri: `https://api.github.com/users/${
        req.params.username
      }/repos?per_page=5&sort=created:asc&clien_id=${config.get(
        "githubClientId"
      )}&client_secret=${config.get("githubSecret")}`,
      method: "GET",
      headers: { "user-agent": "node.js" },
      proxy: "http://usrct6dgsm:cZF$Eyyo@10.1.10.2:8080/"
    };
